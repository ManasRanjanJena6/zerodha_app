  ...
  return (
    <div className="container mt-5">
      <div className="row text-center">
        ...
        <div className="col-4 p-3 mt-5">
          <img src="/media/images/sensibullLogo.svg" alt="Sensibull Logo" className="universe-logo"/>
        ...
        <div className="col-4 p-3 mt-5">
          <img src="/media/images/goldenpiLogo.png" alt="GoldenPi Logo" className="universe-logo"/>
        ...
        <div className="col-4 p-3 mt-5">
          <img src="/media/images/streakLogo.png" alt="Streak Logo" className="universe-logo"/>
        ...
        <div className="col-4 p-3 mt-5">
          <img src="/media/images/smallcaseLogo.png" alt="Smallcase Logo" className="universe-logo"/>
        ...
        <div className="col-4 p-3 mt-5">
          <img src="/media/images/dittoLogo.png" alt="Ditto Logo" className="universe-logo"/>
